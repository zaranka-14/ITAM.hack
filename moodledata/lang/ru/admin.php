...
/**
 * Strings for component 'admin', language 'ru', version '4.2'.
 *
 * @package     admin
 * @category    string
...
$string['debugtemplateinfo_desc'] = 'При включенном параметре шаблоны, используемые для визуализации, отображаются в виде комментариев в HTML-коде страницы. Используйте только для временной отладки, так как это приводит к ошибкам проверки HTML и может нарушить работу скриптов некоторых страниц.';
...
$string['taskquestionstatscleanupcron'] = 'Бывшая фоновая очистка статистики вопросов (больше не требуется)';
