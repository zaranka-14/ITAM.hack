...
/**
 * Strings for component 'treasurehunt', language 'ru', version '4.2'.
 *
...
$string['attempthistory'] = 'История попыток';
$string['attemptsdeleted'] = 'Попытки удалены';
$string['autolocate_tour'] = 'Покажите свое <b>текущее местоположение</b>.<br>(дайте разрешение на использование "местоположения" при запросе)';
$string['availability'] = 'Доступность';
$string['availableplayerstyles'] = 'Доступны стили игрового экрана.';
$string['back'] = 'Назад';
$string['backtocourse'] = 'Вернуться в курс';
$string['baselayers'] = 'Базовые слои';
$string['basemaps'] = 'Вид карты';
$string['bigbutton_play_tour'] = 'Это ваш лучший друг.<br>Нажмите, и вы увидите <b>задачи</b> или ценные <b>подсказки</b>.';
...
$string['custommapimageerror'] = 'Не удается загрузить пользовательское изображение. Проверьте настройки игры.';
...
$string['defaultplayerstyle'] = 'Стиль игрового экрана по умолчанию';
...
$string['edition_help'] = 'Чтобы включить создание геометрии и кнопки на панели редактирования, необходимо выбрать  этап, который вы хотите редактировать.';
...
$string['findplace'] = 'Найдите место';
...
$string['mapplay_tour'] = 'На <b>карте</b> показаны все ваши попытки!<br>! Успешные: <img src="pix/success_mark.png" width="28"/><br>Неудачные: <img src="pix/failure_mark.png" width="28"/>';
$string['mapplaymobile_tour'] = 'На <b>карте</b> показаны все ваши попытки!<br>Успешные: <img src="{$a->successurl}" width="28"/><br>Неудачные: <img src="{$a->failureurl}" width="28"/>';
...
$string['nextcamera'] = 'Сменить камеру';
...
$string['nomarksmobile'] = 'Сначала отметьте на карте нужную точку.';
...
$string['overlaylayers'] = 'Слои наложения';
$string['pegmanlabel'] = 'Посмотрите вокруг на StreetView';
$string['play'] = 'Играть';
...
$string['privacy:metadata_treasurehunt_attempts_stageid'] = 'ID этапа, который пытался решить пользователь.';
$string['privacy:metadata_treasurehunt_attempts_timecreated'] = 'Время, в которое пользователь совершил попытку.';
$string['privacy:metadata_treasurehunt_attempts_userid'] = 'ID пользователя, совершившего попытку.';
...
$string['privacy:metadata_treasurehunt_track_treasurehuntid'] = 'ID поиска сокровищ, в который играет пользователь.';
$string['privacy:metadata_treasurehunt_track_userid'] = 'ID отслеживаемого пользователя.';
$string['qrreaded'] = 'QR-код:';
...
$string['sendlocationcontent'] = 'Это действие не может быть отменено.';
$string['sendlocationtitle'] = 'Вы уверены, что хотите отправить это местоположение?';
$string['showclue'] = 'Показать подсказку';
...
$string['totalprogress'] = 'Общий прогресс';
...
$string['treasurehunt:managetreasure'] = 'Управлять Поиском сокровищ';
$string['treasurehunt:managetreasurehunt'] = 'Управлять Поиском сокровищ';
$string['treasurehunt:play'] = 'Играть';
$string['treasurehunt:view'] = 'Просматривать поиск сокровищ';
$string['treasurehunt:viewusershistoricalattempts'] = 'Просматривать истории попыток пользователей';
...
$string['userattempthistory'] = 'История попыток {$a}';
...
$string['validatelocation_tour'] = 'Уверены в местонахождении этапа?<br><b>Отправьте свою позицию</b> и убедитесь, что вы правы.';
