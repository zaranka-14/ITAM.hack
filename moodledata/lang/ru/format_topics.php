...
/**
 * Strings for component 'format_topics', language 'ru', version '4.2'.
 *
...
$string['sectionavailability_title'] = 'Доступность темы';
$string['sectiondelete_title'] = 'Удалить тему?';
$string['sectionmove_title'] = 'Переместить тему';
$string['sectionname'] = 'Тема';
$string['sectionsavailability'] = 'Доступность тем';
$string['sectionsavailability_title'] = 'Доступность тем';
$string['sectionsdelete'] = 'Удалить темы';
$string['sectionsdelete_info'] = 'Это приведет к удалению {$a->count} тем и всех элементов, которые они содержат.';
$string['sectionsdelete_title'] = 'Удалить выбранные темы?';
$string['sectionsmove'] = 'Переместить темы';
$string['sectionsmove_info'] = 'Поместить темы ({$a}) после';
$string['sectionsmove_title'] = 'Переместить выбранные темы';
$string['selectsection'] = 'Выбрать тему {$a}';
