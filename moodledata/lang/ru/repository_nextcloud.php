...
/**
 * Strings for component 'repository_nextcloud', language 'ru', version '4.2'.
 *
...
$string['defaultreturntype'] = 'Тип возврата по умолчанию';
$string['endpointnotdefined'] = 'Конечная точка {$a} не определена.';
$string['external'] = 'Внешний (в Moodle хранятся только ссылки)';
$string['externalpubliclinkwarning'] = 'Предупреждение: этот файл станет общедоступным.';
