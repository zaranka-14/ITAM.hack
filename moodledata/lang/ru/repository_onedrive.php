...
/**
 * Strings for component 'repository_onedrive', language 'ru', version '4.2'.
 *
...
$string['skydrivefilesexist'] = 'Хранилище Microsoft SkyDrive включено, но является устаревшим. Обязательно как можно скорее перенесите файлы из SkyDrive в хранилище OneDrive. В Moodle 4.4 это сделать будет невозможно.';
