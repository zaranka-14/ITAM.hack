...
/**
 * Strings for component 'course', language 'ru', version '4.2'.
 *
 * @package     course
 * @category    string
...
$string['activitychoosertabmode_desc'] = 'В окне выбора перечислены активные элементы и ресурсы, которые учитель может добавить в свой курс. Чтобы добавить элементы на вкладку «Рекомендуемые», перейдите в раздел <a href=\'../course/recommendations.php\'>Рекомендуемые элементы</a>.';
$string['activitychoosertabmodefive'] = 'Помеченные, Рекомендуемые, Все';
$string['activitychoosertabmodefour'] = 'Помеченные, Рекомендуемые, Все, Активные элементы, Ресурсы';
$string['activitychoosertabmodeone'] = 'Помеченные, Все, Активные элементы, Ресурсы, Рекомендуемые';
$string['activitychoosertabmodesix'] = 'Помеченные, Рекомендуемые, Активные элементы, Ресурсы';
