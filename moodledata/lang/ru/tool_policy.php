...
/**
 * Strings for component 'tool_policy', language 'ru', version '4.2'.
 *
 * @package     tool_policy
 * @category    string
...
$string['activate'] = 'Установить статус «Активная»';
...
$string['inactivate'] = 'Установить статус «Неактивная»';
...
$string['statusinfo'] = 'Политика со статусом «Активная» требует, чтобы пользователи давали свое согласие либо при первом входе в систему, либо (для существующих пользователей) при следующем входе в систему.';
