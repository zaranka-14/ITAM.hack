...
/**
 * Strings for component 'theme_adaptable', language 'ru', version '4.2'.
 *
...
$string['buttonradius'] = 'Установите радиус кнопки';
...
$string['buttontextcolorcancel'] = 'Цвет текста кнопки отмены';
$string['buttontextcolordesc'] = 'Цвет текста на кнопках';
$string['buttontextcolordesccancel'] = 'Цвет текста, используемого на кнопках отмены.';
$string['buttontextcolordescscnd'] = 'Цвет текста, используемого на дополнительных кнопках.';
$string['buttontextcolorscnd'] = 'Цвет текста дополнительной кнопки';
$string['categoryhavecustomheader'] = 'Пользовательский заголовок категории';
$string['categoryhavecustomheaderdesc'] = 'Выберите категории верхнего уровня, которые будут иметь собственный заголовок. Чтобы выбрать более одной категории или отменить выбор категории, используйте клавишу «Ctrl». Сохраните и обновите страницу для обновления. Примечание: подкатегории выбранных унаследуют значения настроек.';
$string['categoryheaderbgimage'] = 'Категория «{$a->name}» с фоновым изображением ID «{$a->id}»';
$string['categoryheaderbgimagedesc'] = 'Установите фоновое изображение для заголовка в категории верхнего уровня «{$a->name}» с ID «{$a->id}». Минимальный размер 1600x180px (рекомендуется 1900x180px). Изображение займет весь заголовок.';
$string['categoryheadercustomtitledesc'] = 'Установите свой заголовок для категории верхнего уровня «{$a->name}» с ID «{$a->id}». Если поле не заполнено, вам будет показан вид с настройками «sitetitle» и «sitetitletext» на страницах, не относящихся к курсу, или на страницах курса, когда параметр «enableheading» отключен. При заполнении на страницах, не связанных с категориями курсов, это заменит заголовок сайта. При заполнении на страницах курса оно будет отображаться над заголовком, как установлено настройкой «enableheading». Но на мобильных устройствах любой «заголовок» будет отображаться только в зависимости от настройки «responsivecoursetitle».';
...
$string['cdefaulticon'] = 'Значок по умолчанию для моих курсов';
$string['cfrozenicon'] = 'Отключить значок для Моих курсов';
$string['chiddenicon'] = 'Скрыть значок Мои курсы';
...
$string['configtabtitle'] = 'Настройки';
$string['configtitle'] = 'Adaptable';
$string['course'] = 'Курс';
$string['courseindexitemcolor'] = 'Цвет элемента';
$string['courseindexsettings'] = 'Содержание курса';
...
$string['coursepageblocksliderenableddesc'] = 'Включите этот регион на всех страницах курса';
$string['coursepagesidebarinfooterenabledsection'] = 'Общие настройки';
$string['coursepagesidebarinfooterenabledsectiondesc'] = 'Общие настройки для большинства форматов курсов.';
$string['courses'] = 'Курсы';
$string['coursesearch'] = 'Поиск курса';
$string['coursesectionactivitybordercolor'] = 'Цвет нижней границы активного раздела курса';
$string['coursesectionactivitybordercolordesc'] = 'Установите цвет нижней границы активного раздела курса';
$string['coursesectionactivityborderstyle'] = 'Стиль нижней границы раздела курса';
$string['coursesectionactivityborderstyledesc'] = 'Установите стиль нижней границы активного раздела курса';
$string['coursesectionactivityforumleftbordercolordesc'] = 'Установите цвет левой границы';
$string['coursesectionactivityquizbgcolor'] = 'Фоновый цвет для теста';
$string['coursesectionactivityquizleftbordercolordesc'] = 'Установите цвет левой границы';
$string['coursesectionbgcolor'] = 'Цвет фона раздела курса';
