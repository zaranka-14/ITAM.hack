...
/**
 * Strings for component 'enrol_fee', language 'ru', version '4.2'.
 *
 * @package     enrol_fee
 * @category    string
...
$string['fee:config'] = 'Настраивать платное зачисление';
...
$string['status'] = 'Разрешить зачисление при регистрации платежей';
