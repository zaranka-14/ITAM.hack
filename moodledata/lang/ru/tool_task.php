...
/**
 * Strings for component 'tool_task', language 'ru', version '4.2'.
 *
 * @package     tool_task
 * @category    string
...
$string['adhoctasksdue'] = 'Срок выполнения разовых задач';
$string['adhoctasksfailed'] = 'Сбой разовых задач';
$string['adhoctasksfuture'] = 'Будущие разовые задачи';
$string['adhoctasksrunning'] = 'Запуск разовых задач';
...
$string['payload'] = 'Полезная нагрузка';
$string['pid'] = 'PID';
