...
/**
 * Strings for component 'videotime', language 'ru', version '4.2'.
 *
 * @package     videotime
 * @category    string
...
$string['display_options'] = 'Параметры отображения';
$string['done'] = 'Готово';
...
$string['enabletabs'] = 'Разрешить вкладки';
...
$string['option_controls'] = 'Управление';
...
$string['option_loop'] = 'Зациклить';
$string['option_loop_help'] = 'Как только видео закончится, оно начнется сначала.';
...
$string['option_playsinline'] = 'Воспроизведение в режиме inline';
$string['option_playsinline_help'] = 'Воспроизведение видео в режиме inline на мобильных устройствах. Для автоматического перехода в полноэкранный режим при воспроизведении снимите эту галочку.';
...
$string['show_description_in_player'] = 'Показывать описание над видеоплеером.';
$string['showtab'] = 'Показать вкладку';
$string['tabinformation'] = 'Информация';
$string['tabs'] = 'Вкладки';
$string['video_description'] = 'Заметки';
$string['video_description_help'] = 'Заметки отображаются под видео.';
