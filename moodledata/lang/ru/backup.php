...
/**
 * Strings for component 'backup', language 'ru', version '4.2'.
 *
 * @package     backup
 * @category    string
...
$string['generalxapistate'] = 'Включить состояние пользователя в контент, такой как активные элементы H5P.';
...
$string['rootsettingxapistate'] = 'Включить состояние пользователя в контент, такой как активные элементы H5P.';
