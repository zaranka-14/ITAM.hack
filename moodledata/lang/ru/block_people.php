...
/**
 * Strings for component 'block_people', language 'ru', version '4.2'.
 *
...
$string['setting_linkavatar'] = 'Ссылка на аватаре';
$string['setting_linkavatar_desc'] = 'При включенном параметре к аватару учителя будет добавлена ссылка на страницу его профиля. Ссылка будет добавлена только в том случае, если пользователю разрешено просматривать профили пользователей.';
$string['setting_linkingheading'] = 'Размещение ссылок';
$string['setting_linkmessaging'] = 'Ссылка для сообщений';
$string['setting_linkmessaging_desc'] = 'При включенном параметре под именем учителя будет добавлена ссылка на страницу обмена сообщениями. Ссылка будет добавлена только в том случае, если пользователю разрешено отправлять сообщения учителю.';
$string['setting_linkname'] = 'Ссылка на имени';
$string['setting_linkname_desc'] = 'При включенном параметре к имени учителя будет добавлена ссылка на страницу его профиля. Ссылка будет добавлена только в том случае, если пользователю разрешено просматривать профили пользователей.';
